...
import 'package:remake_spotify/pages/homepage.dart';
      ...
      body: SafeArea(
        child: Container(
          ...
          child: ListView(children: [
            ...
            textForm(hintText: "Enter Username Or Email"),
            SizedBox(
              height: heightScreen * 1.90 / 100,
            ),
            textFormPassword(hintText: "Password"),
            SizedBox(
              height: heightScreen * 2.37 / 100,
            ),
            Text(
              'Recovery Password',
              style:
                  fontWhite.copyWith(fontSize: 14, fontWeight: FontWeight.bold),
            ),
            SizedBox(
              height: heightScreen * 2.61 / 100,
            ),
